...
@Component({
  selector: 'app-dashboardsubmissions',
  templateUrl: './dashboardsubmissions.component.html',
  styleUrls: ['./dashboardsubmissions.component.css']
})
export class DashboardsubmissionsComponent implements OnInit, OnDestroy {
